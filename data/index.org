...
<head>
    ...
    <script>
        ...
        var timeLag = 0;
        var recTime = 0;
        var colorSet = ["#ff0000", "#009900", "#0000ff", "#cc9900", "#FF1493", "	#FF4500", "	#6495ED", "rgb(116,0,128)", "rgb(0,128,93)", "rgb(128,0,70)"];
        $(document).ready(function() {
            $.getJSON("config.txt", function(config) {
                configulation = config;
                $.each(config.series, function(key, field) {
                    series.push(field.name);
                    $('.tempReading').eq(key).css('color', colorSet[key]);
                    $('.chNum').eq(key).css('color', colorSet[key]);
                    if (key == 0)
                        $("#seriesCb").append('<input type="checkbox" checked onClick="seriesShow(this)"  value=0 name="ShowAll" id="id' + key + '"><label for="id' + key + '">Show/hide All</label>');
                    else
                        $("#seriesCb").append('<input type="checkbox" class="scb" value=' + (key) + ' onClick="seriesShow(this)" checked="true" name="TCcb" id="id' + key + '"><label for="id' +
                ...
                $("#seriesCb").enhanceWithin().controlgroup("refresh");
                createGraph();
                loadData();
            });
        });
        ...
        function seriesShow(el) {
            if (el.value == 0) {
                if (el.checked)
                    var v = [true, true, true, true, true, true, true, true, true, true];
                else
                    var v = [false, false, false, false, false, false, false, false, false, false];
                g2.updateOptions({
                    visibility: v
                });

                $(".scb").prop('checked', el.checked).checkboxradio("refresh");
            } else {
                g2.setVisibility(el.value - 1, el.checked);
            }
        ...
        // $(document).ready(function() {
        //     $('.tempReading').each(function(i, TR) {
        //         $(this).css('color', colorSet[i]);
        //         $('.chNum').eq(i).css('color', colorSet[i]);
        //
        //     });
        //
        // });
    ...
    <div data-role="page">
        ...
        <div role="main" class="ui-content">
            ...
            <div id="butDiv" class="ui-grid-b" data-position-fixed="true">
                ...
                <div class="ui-block-c">
                    <a href="#popupMenu" data-rel="popup" class="ui-shadow ui-btn ui-corner-all ui-mini">Series</a>
                    <div data-role="popup" id="popupMenu" data-theme="b">
                        <fieldset id="seriesCb" data-role="controlgroup">
            ...
            <ul data-role="listview">
                ...
                <li>
                    ...
                    <fieldset data-role="controlgroup" data-type="horizontal" data-mini="true">
                        <input type="radio" name="radio-period" id="radio-sec" value="1" max="60">
                        <label for="radio-sec">Sec.</label>
                        <input type="radio" name="radio-period" id="radio-min" value="60" max="18" checked>
                    ...
                    <input type="range" name="realPeriod" id="realPeriod" data-highlight="true" data-popup-enabled="true" min="1" max="1000" value="1">
                    </from>
                </li>
                <li>
